...
class DSLFactor(Factor):
    def __init__(self):
        self.spec = FactorSpec(
            ...
            lookback=20,
            horizon=5,
            params={"expression": 'div(overnight,std(amplitude,5))'},
            tags=["dsl", "loop"],
            hypothesis='跳空/隔夜；compose div(overnight,std(amplitude,5))',
            entry_gate="research",
            expression='div(overnight,std(amplitude,5))',
            mechanism='overnight',
        )
