...
class DSLFactor(Factor):
    def __init__(self):
        self.spec = FactorSpec(
            name="liquidity_c10_103628_1891",
            version="0.1.0",
            status="draft",
            family="price_volume",
            category="liquidity",
            ...
            lookback=20,
            horizon=5,
            params={"expression": """delay(turnover_rate,10)"""},
            tags=["dsl", "loop"],
            hypothesis="""流动性/成交；compose delay(turnover_rate,10)""",
            entry_gate="research",
            expression="""delay(turnover_rate,10)""",
            mechanism="liquidity",
        )
